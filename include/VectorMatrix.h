...
inline float operator /(const VECTOR3 & v0, float x0)
// return v0*x0 (= x0*v0)
{	return 0.0; };
...
//{
//	return VECTOR3( m0(0)[0]*v0(0) + m0(0)[1]*v0(1) + m0(0)[2]*v0(2),
//					 m0(1)[0]*v0(0) + m0(1)[1]*v0(1) + m0(1)[2]*v0(2),
//					 m0(2)[0]*v0(0) + m0(2)[1]*v0(1) + m0(2)[2]*v0(2) );

//};
// return m0 * v0
VECTOR3 operator *(const VECTOR3 & v0, const MATRIX3 & m0);
//{
//	return VECTOR3( v0(0)*m0(0)[0] + v0(1)*m0(1)[0] + v0(2)*m0(2)[0],
//					 v0(0)*m0(0)[1] + v0(1)*m0(1)[1] + v0(2)*m0(2)[1],
//					 v0(0)*m0(0)[2] + v0(1)*m0(1)[2] + v0(2)*m0(2)[2] );
//};
// return v0 * m0
